...
const skills = [
  ...
  {
    name: "React.js",
    description: "SPA, Custom Hooks, Context API",
    category: "Frontend",
    level: "Core Stack",
    color: "#61DAFB",
    icon: SiReact,
  ...
  {
    name: "Node.js",
    description: "Runtime Environment, REST APIs",
    category: "Backend",
    level: "Intermediate",
    color: "#339933",
    icon: SiNodedotjs,
  ...
  {
    name: "BetterAuth",
    description: "Session & Auth Management",
    category: "Backend",
    level: "Proficient",
    color: "#7C3AED",
    icon: ShieldCheck,
  ...
  return (
    ...
    >
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`relative px-3 py-2.5 sm:px-6 rounded-xl text-xs sm:text-sm font-bold transition-all duration-300 z-10 focus:outline-none flex items-center justify-center text-center border cursor-pointer whitespace-nowrap ${active
              ...
              >
                {active && (
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-fuchsia-600 text-white rounded-xl -z-10 shadow-md shadow-purple-500/30" />
                )}
      ...
      <div
        ...
        className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-5 items-start content-start min-h-[400px] sm:min-h-[280px]"
      >
          ...
          return (
            ...
            >
              ...
              <div className="w-full flex items-center justify-between mb-4 z-10 gap-1">
                <div
                  className="text-3xl sm:text-4xl transition-transform duration-300 group-hover:scale-110 flex items-center justify-center shrink-0"
                  style={{
                    color: skill.color,
                  }}
                >
